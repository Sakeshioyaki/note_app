...
//     return Scaffold(
//               body: buildMyNote(),
//               floatingActionButton: buildFloatingActionIsDeleteFalse(context),
//             );
//
//   }
//
...
//   }
//
//   Widget buildListCardNote(List<NoteModel?> notes) {
//     return Expanded(
...
//             {
//               if (element == note.id) (acceptDelete = true);
//             }
...
//   }
//
//   Widget buildSearchContent(List<NoteModel?> notes) {
//     return Expanded(
...
//       {required String textSearch, required List<NoteModel?> notes}) {
...
//   }
//
//   Widget buildContent(NoteModel note, bool isDeleting) {
//     return Container(
//       decoration: BoxDecoration(
